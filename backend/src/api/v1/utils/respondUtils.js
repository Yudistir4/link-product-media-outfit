const customRespond = {
  TokenInvalid: { message: 'Token is not valid', code: 403 },
  InvalidPassword: { message: 'Invalid Password', code: 400 },
  DuplicatedUser: { message: 'Email already registered', code: 409 },
  UserNotFound: { message: 'User Not Found', code: 400 },
  RecordCreated: { message: 'Record created', code: 201 },
  SignupSuccess: { message: 'Signup success', code: 201 },
